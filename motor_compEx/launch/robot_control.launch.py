...
def generate_launch_description():
    ...
    robot_control_config = PathJoinSubstitution(
        [FindPackageShare("motor_compEx"), "config/robot_control", "ros2_controllers.yaml"]
    )

    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("motor_compEx"), "rviz", "view_robot.rviz"]
    )
